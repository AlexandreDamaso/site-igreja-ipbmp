...
<head>
   ...
   <!-- Theme color -->
   <link id="switcher" href="./src/css/theme-color/default-theme.css" rel="stylesheet">
...
<body>
   ...
   <div id="aa-preloader-area">
      <div class="mu-preloader">
         <img src="./src/img/preloader.gif" alt=" loader img">
      </div>
   </div>
   <!-- SCROLL TOP BUTTON -->
      ...
      <nav class="navbar navbar-default mu-main-navbar" role="navigation">
         <div class="container">
            <div class="navbar-header">
               ...
               <!-- LOGO -->
               <a class="navbar-brand" href="index.html"><img src="./src/img/logo.png" alt="Logo img"></a>
            </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-6 col-sm-6">
                                          <article class="mu-news-single">
                                             ...
                                             <figure class="mu-news-img">
                                                <a href="#"><img alt="img" src="./src/img/news/1.jpg"></a>
                                             </figure>
                                             <div class="mu-news-single-content">
                                                <ul class="mu-meta-nav">
                                                   <li>By Admin</li>
                                       ...
                                       <div class="col-md-6 col-sm-6">
                                          <article class="mu-news-single">
                                             <h3><a href="#">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque, distinctio!</a></h3>
                                             <figure class="mu-news-img">
                                                <a href="#"><img alt="img" src="./src/img/news/2.jpg"></a>
                                             </figure>
                                             <div class="mu-news-single-content">
                                                <ul class="mu-meta-nav">
                                                   <li>By Admin</li>
                                 ...
                                 <div class="comments">
                                    <ul class="commentlist">
                                       <li>
                                          <div class="media">
                                             <div class="media-left">
                                                <img class="media-object news-img" src="./src/img/testimonial-1.png" alt="img">
                                             </div>
                                       ...
                                       <li>
                                          <div class="media">
                                             <div class="media-left">
                                                <img class="media-object news-img" src="./src/img/testimonial-2.png" alt="img">
                                             </div>
                                             <div class="media-body">
                                       ...
                                       <ul class="children">
                                          <li class="author-comments">
                                             <div class="media">
                                                <div class="media-left">
                                                   <img class="media-object news-img" src="./src/img/testimonial-3.png" alt="img">
                                                </div>
                                                <div class="media-body">
                        ...
                        <aside class="mu-blog-sidebar">
                           ...
                           <div class="mu-blog-sidebar-single">
                              <a href="#" class="mu-sidebar-add">
                                 <img src="./src/img/banner-ads.jpg" alt="img">
                              </a>
                           </div>
                           <!-- End Blog Sidebar Single -->
                        </aside>
